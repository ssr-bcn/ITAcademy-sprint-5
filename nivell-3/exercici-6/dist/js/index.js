...
const JOKE_JOKE_API = 'https://v2.jokeapi.dev/joke/Any?lang=en&blacklistFlags=nsfw&type=single';
...
let UI = {
    ...
    changeBackground() {
        var _a;
        let classes = (_a = this.main) === null || _a === void 0 ? void 0 : _a.classList;
        classes === null || classes === void 0 ? void 0 : classes.remove(...classes);
        classes === null || classes === void 0 ? void 0 : classes.add(`bg${Math.floor(Math.random() * 8) + 1}`);
    }
};
// EVENT LISTENERS ------------------------------------------------------------
